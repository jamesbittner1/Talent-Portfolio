...
func Router() *mux.Router {
	...
	router.HandleFunc("/api/skill/{id}", middleware.GetSkill).Methods("GET", "OPTIONS")
	router.HandleFunc("/api/skill", middleware.GetAllSkill).Methods("GET", "OPTIONS")
    router.HandleFunc("/api/newskill", middleware.CreateSkill).Methods("POST", "OPTIONS")
    router.HandleFunc("/api/skill/{id}", middleware.UpdateSkill).Methods("PUT", "OPTIONS")
